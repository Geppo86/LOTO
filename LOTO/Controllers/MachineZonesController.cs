...
namespace LOTO.Controllers
{
    public class MachineZonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MZID,NameMachineZone,ZoneMapFile,HatchingFile")] MachineZone MachineZone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MZID,NameMachineZone,ZoneMapFile,HatchingFile")] MachineZone MachineZone)
        {
